...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Nghe cảnh báo - Ngoại tuyến"))
        ...
        item.setText(_translate("MainWindow", "Kênh"))
        item = self.Alarmlisten_tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Loại cảnh báo"))
        item = self.Alarmlisten_tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Trạng thái"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Đăng ký cảnh báo"))
        self.Alarmlisten_pushButton.setText(_translate("MainWindow", "Bắt đầu nghe cảnh báo"))
        self.Stopalarmlisten_pushButton.setText(_translate("MainWindow", "Dừng nghe cảnh báo"))

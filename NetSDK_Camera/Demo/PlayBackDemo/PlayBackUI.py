...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Xem lại video"))
        self.groupBox.setTitle(_translate("MainWindow", "Đăng nhập thiết bị"))
        self.label.setText(_translate("MainWindow", "Địa chỉ IP"))
        self.label_2.setText(_translate("MainWindow", "Cổng"))
        ...
        self.PlayBackWnd.setText(_translate("MainWindow", "Xem lại video"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Thao tác xem lại"))
        self.exist_radioButton.setText(_translate("MainWindow", "Có video lưu"))
        ...
        self.Pause_pushbutton.setText(_translate("MainWindow", "Tạm dừng"))
        self.PlayBack_pushbutton.setText(_translate("MainWindow", "Phát"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Tải xuống"))
        self.Start_dateTimeEdit.setDisplayFormat(_translate("MainWindow", "yyyy/M/d HH:mm:ss"))
        self.label_7.setText(_translate("MainWindow", "Thời gian bắt đầu"))

...
class Ui_InitDevAccount(object):
    ...
    def retranslateUi(self, InitDevAccount):
        ...
        InitDevAccount.setWindowTitle(_translate("InitDevAccount", "Khởi tạo thiết bị"))
        self.username_label.setText(_translate("InitDevAccount", "Tên đăng nhập"))
        self.confirm_password_label.setText(_translate("InitDevAccount", "Xác nhận mật khẩu"))
        self.reser_way_label.setText(_translate("InitDevAccount", "Phương thức đặt lại"))
        self.password_label.setText(_translate("InitDevAccount", "Mật khẩu"))
        self.pushButton.setText(_translate("InitDevAccount", "Xác nhận"))

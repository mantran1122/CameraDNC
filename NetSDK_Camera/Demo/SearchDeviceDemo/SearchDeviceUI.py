...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Tìm kiếm thiết bị"))
        self.devicelist_groupBox.setTitle(_translate("MainWindow", "Danh sách thiết bị"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "STT"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "Trạng thái"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "Phiên bản IP"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "Địa chỉ IP"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "Cổng"))
        item = self.tableWidget.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Subnet Mask"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "Gateway"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "Địa chỉ MAC"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "Loại thiết bị"))
        item = self.tableWidget.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "Loại chi tiết"))
        item = self.tableWidget.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "Http"))
        self.searchdevice_groupBox.setTitle(_translate("MainWindow", "Tìm kiếm thiết bị"))
        self.SearchDeviceButton.setText(_translate("MainWindow", "Tìm kiếm (Multicast & Broadcast)"))
        self.Searchtime_label.setText(_translate("MainWindow", "Thời gian tìm kiếm (ms):"))
        self.Searchtime_lineEdit.setText(_translate("MainWindow", "3000"))
        self.Init_groupBox.setTitle(_translate("MainWindow", "Thao tác thiết bị"))
        self.InitButton.setText(_translate("MainWindow", "Khởi tạo thiết bị"))
        self.SearchByIpButton.setText(_translate("MainWindow", "Tìm kiếm theo IP"))
        self.groupBox.setTitle(_translate("MainWindow", "Tìm kiếm theo dải IP"))
        self.StartIP_label.setText(_translate("MainWindow", "IP bắt đầu"))
        self.label_2.setText(_translate("MainWindow", "IP kết thúc"))

...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Xem trực tiếp"))
        self.PlayWnd.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><br/></p><p align=\"center\">Xem trực tiếp</p></body></html>"))
        self.IP_label.setText(_translate("MainWindow", "Địa chỉ IP"))
        self.Port_label.setText(_translate("MainWindow", "Cổng"))
        self.Name_label.setText(_translate("MainWindow", "Tên đăng nhập"))
        self.Pwd_label.setText(_translate("MainWindow", "Mật khẩu"))
        self.Channel_label.setText(_translate("MainWindow", "Kênh"))
        self.login_btn.setText(_translate("MainWindow", "Đăng nhập"))
        self.play_btn.setText(_translate("MainWindow", "Xem"))
        self.StreamTyp_comboBox.setItemText(0, _translate("MainWindow", "Luồng chính"))
        self.StreamTyp_comboBox.setItemText(1, _translate("MainWindow", "Luồng phụ"))
        self.label_5.setText(_translate("MainWindow", "Loại luồng"))

...
if (typeof qt === 'undefined') {
    ...
    var MOCK_APP_DATA = {
        demos: [
            ...
            { label: "Chụp ảnh",                module_path: "", module_name: "CaptureDemo",           class_name: "CaptureWnd",    icon_key: "fa-camera",      description: "Chụp snapshot từ luồng camera hiện tại.",                           category: "Camera",     accent: "#8B5CF6", keywords: ["chụp","ảnh","snapshot","capture","picture"] },
            ...
            { label: "Xem lại video",            module_path: "", module_name: "PlayBackDemo",          class_name: "MyMainWindow",  icon_key: "fa-play-circle", description: "Truy xuất và phát lại video đã được ghi trên thiết bị.",           category: "Playback",   accent: "#A855F7", keywords: ["playback","xem lại","video","record","replay"] },

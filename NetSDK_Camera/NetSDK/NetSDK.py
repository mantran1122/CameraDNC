...
netsdkdllpath_dict = {'windows64': os.path.join(_sdk_root, 'libs', 'Win64', 'dhnetsdk.dll'), 'windows32': os.path.join(_sdk_root, 'libs', 'Win32', 'dhnetsdk.dll')}
configdllpath_dict = {'windows64': os.path.join(_sdk_root, 'libs', 'Win64', 'dhconfigsdk.dll'), 'windows32': os.path.join(_sdk_root, 'libs', 'Win32', 'dhconfigsdk.dll')}
...
class NetClient(metaclass=Singleton):
    ...
    def LoginEx2(cls, ip: str, port: int, username: str, password: str,
        ...
        login_error = {
            ...
            3: 'Đăng nhập hết thời gian chờ',
            4: 'Đăng nhập trùng lặp',
            5: 'Tài khoản bị khóa',
            6: 'Tài khoản trong danh sách đen',
            7: 'Hệ thống bận, không đủ tài nguyên',
            8: 'Kết nối phụ thất bại',
            9: 'Kết nối chính thất bại',
            10: 'Vượt quá số kết nối tối đa',
            11: 'Chỉ hỗ trợ giao thức thế hệ 3',
            12: 'Thiết bị chưa cắm U-shield hoặc thông tin sai',
            13: 'IP máy khách không có quyền đăng nhập',
            18: 'Tài khoản thiết bị chưa được khởi tạo'
        }
        if login_id == 0:
            try:

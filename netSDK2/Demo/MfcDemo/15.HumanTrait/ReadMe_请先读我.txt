【Demo功能】
1、Demo演示了SDK初始化、登陆、拉流、人体检测事件的上报和人体检测图片的结构化搜索。

【注意事项】
1、编译环境为VS2005。
2、demo端只演示的人体检测功能需要前端或者后端设备支持该功能。
...
【Demo Features】
1.Demo SDK initialization,login device, real play, report human trait event and search human trait picture.

【NOTE】
1.Complier for Demo is VS2005.
2.Demo features require device support.

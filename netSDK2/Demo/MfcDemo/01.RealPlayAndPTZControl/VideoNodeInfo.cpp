...
// Set VideoInfo
void CVideoNodeInfo::SetVideoInfo(int iDisplayNum, CString strDvrIP, WORD wPort, int iChannel, CString strUserName, CString strPwd, enum RealPlayMode ePlayMode,enum ConvertType eConvertType)
{
	m_iDisplayNum=iDisplayNum;
	m_strDvrIP=strDvrIP;
	m_wDvrPort=wPort;
